        ...
        <div class="zonne_dinformation"> <!--zone d'information -->
            ...
            <div class="zone_de_categorie"><!--zone de categorie-->
                ...
                <div> <!--Prestataire-->
                    ...
                    <div>
                        <input type="radio" name="prestataire" value="no">
                        <label for="">Non</label>
                    </div>
                    <div>
                        <input type="radio" name="prestataire" value="yes">
                        <label for="">Oui</label>
                    </div>
                    <div>
                ...
                <div> <!--Conforme-->
                    ...
                    <div>
                        <input type="radio" name="conforme" value="no">
                        <label for="">Non</label>
                    </div>
                    <div>
                        <input type="radio" name="conforme" value="yes">
                        <label for="">Oui</label>
                    </div>
                    <div>
                ...
                <div> <!--Periode de naissance-->
                    ...
                    <div>
                        ...
                        <input type="checkbox" name="actif" id="">
                    </div>
                    <div>
