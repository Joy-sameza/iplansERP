    ...
    <tr style="pointer-events: all !important;">
        ...
        <td id='option'>
            <div class="d-flex">
                ...
                <div class="tooltip47">
                    <button class="bouton bg-success btn-modif" onclick=''><i class="fas fa-edit"></i>
...
<script>
   ...
   document.addEventListener("DOMContentLoaded", function() {
    ...
    // });
            ...
            const prenom = targetRow.querySelector('[data-prenom]').textContent;
            //const prenom = targetRow.cells[3].textContent;
            const fonction = targetRow.querySelector('[data-fonction]').textContent;
            //const fonction = targetRow.cells[4].textContent;
           // const phone = targetRow.cells[5].textContent;
            const phone = targetRow.querySelector('[data-phone]').textContent;
            //const pseudo = targetRow.cells[6].textContent;
            const pseudo = targetRow.querySelector('[data-pseudo]').textContent;
            
           // const matricule = targetRow.cells[7].textContent;
            const matricule = targetRow.querySelector('[data-matricule]').textContent;
           // const cni= targetRow.cells[9].textContent;
            const cni = targetRow.querySelector('[data-cni]').textContent;
            //const email = targetRow.cells[10].textContent;
            const email = targetRow.querySelector('[data-email]').textContent;
           // const dnais = targetRow.cells[11].textContent;
            const dnais= targetRow.querySelector('[data-dnais]').textContent;
            //const npere= targetRow.cells[12].textContent;
            const npere = targetRow.querySelector('[data-npere]').textContent;
            //const nmere = targetRow.cells[13].textContent;
            const nmere= targetRow.querySelector('[data-nmere]').textContent;
           // const vnais= targetRow.cells[14].textContent;
            const vnais = targetRow.querySelector('[data-vnais]').textContent;
            //const nurg= targetRow.cells[15].textContent;
            const nurg= targetRow.querySelector('[data-nurg]').textContent;
            //const nuurg = targetRow.cells[16].textContent;
            const nuurg= targetRow.querySelector('[data-nuurg]').textContent;
           // const agenceBanque = targetRow.cells[17].textContent;
            const agenceBanque = targetRow.querySelector('[data-agenceBanque]').textContent;
            //const codeBanque = targetRow.cells[18].textContent;
            const codeBanque = targetRow.querySelector('[data-codeBanque]').textContent;
            const  codeguichet= targetRow.querySelector('[data-codeguichet]').textContent;
           // const codeguichet = targetRow.cells[19].textContent;
           // const numcomptbanque = targetRow.cells[20].textContent;
            const numcomptbanque = targetRow.querySelector('[data-numcomptbanque]').textContent;
            //const cleRib = targetRow.cells[21].textContent;
            const cleRib = targetRow.querySelector('[data-cleRib]').textContent;
            //const CodeSwiftBanque = targetRow.cells[22].textContent;
            const CodeSwiftBanque = targetRow.querySelector('[data-CodeSwiftBanque]').textContent;

            //const CodeUtilisateur = targetRow.cells[23].textContent;
            const CodeUtilisateur = targetRow.querySelector('[data-CodeUtilisateur]').textContent;
            //const categorie = targetRow.cells[24].textContent;
            const categorie = targetRow.querySelector('[data-categorie]').textContent;
            const Grade = targetRow.querySelector('[data-Grade]').textContent;
           // const Grade = targetRow.cells[25].textContent;
           // const Convention = targetRow.cells[26].textContent;
            const Convention = targetRow.querySelector('[data-Convention]').textContent;
            //const departement1 = targetRow.cells[27].textContent;
            const departement1 = targetRow.querySelector('[data-departement1]').textContent;
            //const genre_salarie = targetRow.cells[28].textContent;
            const genre_salarie = targetRow.querySelector('[data-genre_salarie]').textContent;
            //const Direction = targetRow.cells[29].textContent;
            const Direction = targetRow.querySelector('[data-Direction]').textContent;
            //const SousDirection = targetRow.cells[30].textContent;
            const SousDirection = targetRow.querySelector('[data-SousDirection]').textContent;
            //const Service = targetRow.cells[31].textContent;
            const Service = targetRow.querySelector('[data-Service]').textContent;
            //const motif_depart = targetRow.cells[32].textContent;
            const motif_depart = targetRow.querySelector('[data-motif_depart]').textContent;
           // const date_sortie = targetRow.cells[33].textContent;
            const date_sortie = targetRow.querySelector('[data-date_sortie]').textContent;
            //const date_entree = targetRow.cells[34].textContent;
            const date_entree = targetRow.querySelector('[data-date_entree]').textContent;
            //const type_contrat = targetRow.cells[35].textContent;
            const  type_contrat= targetRow.querySelector('[data-type_contrat]').textContent;
            //const IDDate_Contrat = targetRow.cells[36].textContent;
            const IDDate_Contrat = targetRow.querySelector('[data-IDDate_Contrat]').textContent;
            //const IDDate_Sortie = targetRow.cells[37].textContent;
            const IDDate_Sortie = targetRow.querySelector('[data-IDDate_Sortie]').textContent;
           // const LieuDelivranceCNI = targetRow.cells[38].textContent;
            const LieuDelivranceCNI = targetRow.querySelector('[data-LieuDelivranceCNI]').textContent;
            //const DateExpirationCNI = targetRow.cells[39].textContent;
            const  DateExpirationCNI= targetRow.querySelector('[data-DateExpirationCNI]').textContent;
            //const IDDateExpirationCNI = targetRow.cells[40].textContent;
            const IDDateExpirationCNI  = targetRow.querySelector('[data-IDDateExpirationCNI]').textContent;
