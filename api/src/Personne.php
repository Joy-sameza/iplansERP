...
class Personne
{
    ...
    /**
     * Retrieves all Site values from the siteiplans table.
     *
     * @return array An array containing all the Site values.
     */
    ...
    public function get($courierId): array | false
    {
        ...
        $query = "SELECT * FROM {$this->table} WHERE NEng = :courierId and supprimer = 0";
...
<<<<<<< HEAD
        $this->civilite = htmlspecialchars(strip_tags($data['civilite']));
            ...
            $this->supprimer = htmlspecialchars(strip_tags($data['supprimer'] ?? 0));
...
=======
        ...
        $this->archivedefinitiveuser = htmlspecialchars(strip_tags($data['ArchiveDefinitiveUser'] ?? 0));
        $this->archivedefinitivemotif = htmlspecialchars(strip_tags($data['ArchiveDefinitiveMotif'] ?? 0));
>>>>>>> c22c43c2a2130310d730984ddda8e55ffc5a4533
...
<<<<<<< HEAD
            ...
            $stmt->bindParam(':supprimer', $this->supprimer, PDO::PARAM_STR);
...
<<<<<<< HEAD
            ...
            $this->supprimer = htmlspecialchars(strip_tags($new_data['supprimer'] ?? $current['supprimer']));
